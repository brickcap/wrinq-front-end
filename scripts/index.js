...
var domElements = {
    ...
    'commentBox':'<div class="box"><p><input type="text" name="to" placeholder="@to"/></p><p><textarea rows="5" name="message" placeholder="your message" onkeyup="autoGrow(this)"></textarea></p><p><input type="text" name="tag" placeholder="optional #tag"/></p></div> <span><button type="button" onclick="send(this)">post</button></span><span><button type="button" onclick="removeCommentBox(this)">cancel</button>',
    ...
    'sendMessage' : '<div  class="box"><p><input type="text" name="to" placeholder="@to"/></p><p><textarea rows="5" placeholder="your message" onkeyup="autoGrow(this)" name="message"></textarea></p><p><input type="text" name="tag" placeholder="optional #tag"/></p></div> <span><button type="button" onclick="send(this)">post</button></span>'
